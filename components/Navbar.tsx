        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 flex items-center justify-between" style={{ height: "6.5rem" }}>
          ...
          <nav className="hidden md:flex items-center gap-7">
            ...
            <div className="relative">
              ...
              {langOpen && (
                <div className="absolute right-0 top-full mt-2 bg-white rounded-md py-2 [filter:drop-shadow(0_8px_24px_rgba(0,0,0,0.18))]">
                  {LOCALES.map((l) => (
                    <Link
                      key={l}
          ...
          <div className="md:hidden flex items-center gap-2">
            <div className="relative">
              ...
              {langOpen && (
                <div className="absolute right-0 top-full mt-2 bg-white rounded-md py-2 z-50 [filter:drop-shadow(0_8px_24px_rgba(0,0,0,0.18))]">
                  {LOCALES.map((l) => (
                    <Link
                      key={l}
                      href={`/${l}${bareHere === "/" ? "" : bareHere}`}
