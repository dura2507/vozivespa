    ...
    <footer className="bg-ink text-white/60">
      <div className="max-w-5xl mx-auto px-5 md:px-12 py-16 flex flex-col items-center text-center">
        ...
        <Link href="/" className="flex items-center gap-2 mb-4">
          ...
          />
          <span className="font-dancing font-bold text-2xl leading-none">
            <span className="text-white">Vozi</span>
            <span className="text-red"> Vespa</span>
          </span>
        </Link>
        <p className="text-sm leading-relaxed text-white/50 max-w-md mb-10">
          Rent a Vespa in Zadar and explore the Dalmatian coast on your own terms.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-x-8 gap-y-3 text-sm mb-8">
          <a href="tel:+4917634658003" className="flex items-center gap-2 text-white/55 hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
            </svg>
            +49 176 34658003
          </a>
          <a href="mailto:info@vozivespa.com" className="flex items-center gap-2 text-white/55 hover:text-white transition-colors">
            <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <p className="mt-12 pt-8 border-t border-white/10 w-full text-xs text-white/30">
          © {new Date().getFullYear()} Vozi Vespa. All rights reserved.
        </p>
      </div>
    </footer>
  );
