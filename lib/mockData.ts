...
export const REVIEWS: Review[] = [
  ...
  {
    id: "2",
    name: "Luca-Sophie Steiger",
    date: "August 2025",
    rating: 5,
    text: "Wir haben während unseres Urlaubs in Kroatien einen Roller gemietet und waren absolut zufrieden! Die Abwicklung war schnell, unkompliziert und das Team super nett und hilfsbereit. Der Roller war in einwandfreiem Zustand, sehr gepflegt und zuverlässig, ideal um die Umgebung flexibel zu erkunden. Preis-Leistung top! Klare Empfehlung, wir würden jederzeit wieder hier mieten!",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    date: "August 2025",
    rating: 5,
    text: "SickMotos ist ein Profiverleih mit viel Fachwissen! Wärmstens zu empfehlen, wenn ihr Roller oder Motorrad in Zadar leihen wollt. Die Besitzer sind freundlich, sehr hilfsbereit und super zu erreichen. Sie hatten tolle Tipps zu local must-sees & -visits. Alles verlief reibungslos und unkompliziert. Mein Roller war top gepflegt, bin sehr happy mit dieser Erfahrung. Hvala puno!",
  },
  {
    id: "5",
    name: "Tillmann",
    date: "August 2025",
    rating: 5,
    text: "Lief alles reibungslos ab, super Service und Erreichbarkeit. Coole Maschinen, Preis-Leistung absolut Top. Kann ich nur empfehlen.",
  },
];
