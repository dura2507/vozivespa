...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Driving requires prior riding experience. If we determine at pickup that experience is insufficient to safely handle the bike, we reserve the right to decline. The booking fee is non-refundable in that case — please be honest about your experience when booking.",
